...
extension AppState {
    ...
    var ideCommands: [IDECommand] {
        [
            ...
            IDECommand(id: "show-data", title: "Show Data", shortcut: "⌘3", action: { self.showSidebarPane(.data) }),
            ...
            IDECommand(id: "insert-code-below", title: "Insert Code Cell Below", shortcut: "B (command mode)", enabled: hasSelectedCell, action: { self.commandInsert(offset: 1) }),
            IDECommand(id: "insert-markdown-above", title: "Insert Markdown Cell Above", shortcut: "", enabled: hasSelectedCell, action: { self.commandInsert(offset: 0, type: .markdown) }),
            IDECommand(id: "insert-markdown-below", title: "Insert Markdown Cell Below", shortcut: "", enabled: hasSelectedCell, action: { self.commandInsert(offset: 1, type: .markdown) }),
            IDECommand(id: "export-pdf", title: "Export Notebook as PDF…", shortcut: "", enabled: activeDocument?.kind == .notebook, action: exportActiveNotebookAsPDF),
            IDECommand(id: "export-html", title: "Export Notebook as HTML…", shortcut: "", enabled: activeDocument?.kind == .notebook, action: exportActiveNotebookAsHTML),
            IDECommand(id: "plots", title: "Show Plots", shortcut: "", action: showPlots),
